...
function App() {
	...
	// Summer
	const avatarBorder =
		"https://cdn.fastly.steamstatic.com/steamcommunity/public/images/items/2861720/410eecdbc6f2505e98863ab4200ca454032b40a2.png";
	...
	const fixedAvatar =
		"https://cdn.fastly.steamstatic.com/steamcommunity/public/images/items/2861720/0f9367f89fad6b92c96b686442d61bcb86d627f5.gif";
			...
			<div className="body">
					...
					<div className="group">
						...
						<p>
							<img
								...
								width="15px"
							/>{" "}
							Hi, I'm <b>Anderson Marlon</b>, a Software Developer, Fullstack
							Developer and Front-end Developer with experience in Javascript,
							Typescript, React.js, Next.js, Vite, Sass, Redux, RegEx, UI/UX,
							Responsive Design, Firebase, Supabase, Hasura, SQL Lite, MySQL,
							PostgreSQL, GraphQL, Jest, Node.js, Express, Fastify, NestJS,
							Bun.js, Whatsapp API, Rocketchat, Serverless, Microservices and
							more …
						</p>
						...
						<div className="groupDetails">
							<div className="badges">
								...
								<img
									src="/nestjs.png"
									alt="BadgeIcon"
									title="NestJS Experience"
								/>
								<img
									src="/firebase.png"
									alt="BadgeIcon"
									title="Firebase Experience"
								/>
								<button
				...
				<div className="sidebar">
					...
					<div className="links">
						...
						<div className="links">
							<a
								href="https://github.com/Yagasaki7K/website-steamfolio"
								className="link"
								target="_blank"
								rel="noreferrer"
							>
							...
							<a
								href="https://github.com/Yagasaki7K/website-onigirihardcore"
								className="link"
								target="_blank"
								rel="noreferrer"
							>
							...
							<a
								href="https://github.com/Yagasaki7K/website-empreguei"
								className="link"
								target="_blank"
								rel="noreferrer"
							>
