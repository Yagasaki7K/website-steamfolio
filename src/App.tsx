    ...
    return loading ? (
        ...
        <SteamDetails>
                    ...
                    <div className="group">
                        ...
                        {articles && articles.length > 0 ? (
                            ...
                            <div className="groupDetails">
                                <span>
                                    <a
                                        href="https://yagasaki.vercel.app/artigo/o-guia-completo-para-desenvolvedores-fullstack-em-2026"
                                        target="_blank"
                                        rel="noreferrer"
                                    >
                                        × O Guia Completo para Desenvolvedores Fullstack em 2026
                                    </a>
                                </span>
                                <span>
                                    <a
                                        href="https://yagasaki.vercel.app/artigo/tutorial-javascript-do-zero-ao-hero-sua-jornada-completa"
                                        target="_blank"
                                        rel="noreferrer"
                                    >
                                        × Tutorial Javascript do Zero ao Hero - Sua Jornada Completa
                                    </a>
                                </span>
                                <span>
                                    <a
                                        href="https://yagasaki.vercel.app/artigo/construindo-sua-operacao-saas-do-zero"
                                        target="_blank"
                                        rel="noreferrer"
                                    >
                                        × Construindo sua Operação SaaS do Zero
                                    </a>
                                </span>
                                <span>
                                    <a
                                        href="https://yagasaki.vercel.app/artigo/inteligencia-artificial-um-guia-completo-claro-e-sem-mistificacao-para-todos"
                                        target="_blank"
                                        rel="noreferrer"
                                    >
                                ...
                                <span>
                                    <a
                                        href="https://yagasaki.vercel.app/artigo/dominando-rest-de-verdade-o-guia-rapido-que-todo-dev-precisa-salvar"
                                        target="_blank"
                                        rel="noreferrer"
                                    >
                ...
                <div className="sidebar">
                    ...
                    <div className="links">
                        ...
                        <a href={githubLink} target="_blank" rel="noreferrer">
                            Public Repositories <span>{userInfo?.public_repos}</span>
                        </a>
                        <a href={githubLink} target="_blank" rel="noreferrer">
                            Total Stars <span>{userRepos?.totalStars}</span>
                        </a>
                        <a href={githubLink} target="_blank" rel="noreferrer">
                        ...
                        <div className="links">
                            <a href="https://github.com/Yagasaki7K/website-steamfolio" className="link" target="_blank" rel="noreferrer">
                                {">"} steamfolio
                            </a>
                            <a href="https://github.com/Yagasaki7K/website-onigirihardcore" className="link" target="_blank" rel="noreferrer">
                                {">"} onigirihardcore
                            </a>
                            <a href="https://github.com/Yagasaki7K/website-essentials" className="link" target="_blank" rel="noreferrer">
                                {">"} essentials
                            </a>
                            <a href="https://github.com/Yagasaki7K/website-empreguei" className="link" target="_blank" rel="noreferrer">
                                {">"} feature/liquid-glass
                            </a>
                            <a href="https://github.com/Yagasaki7K/website-findyourpet" className="link" target="_blank" rel="noreferrer">
                                {">"} findyourpet
                            </a>
                        </div>
                    </div>
            ...
            <div className="copyright">
                <a href="https://github.com/Yagasaki7K" target="_blank" rel="noreferrer">
                    © 2024 - {new Date().getFullYear()} Anderson "Yagasaki" Marlon{" "}
                </a>
            </div>
        </SteamDetails>
    );
